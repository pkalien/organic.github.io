...
<div class="page">
          ...
          <div class="rd-navbar-aside">
            ...
            <div class="rd-navbar-panel">
              ...
              <div class="rd-navbar-brand">
                <!--Brand--><a class="brand" href="index.php"><img class="brand-logo-dark" src="images/logo-default-234x82.png" alt="" width="117" height="41"/><img class="brand-logo-light" src="images/logo-inverse-234x82.png" alt="" width="117" height="41"/></a>
              </div>
            </div>
                ...
                <div class="rd-navbar-nav-wrap">
                  <ul class="rd-navbar-nav">
                    ...
                    <li class="rd-nav-item "><a class="rd-nav-link" href="gallery.php">Gallery</a>
                      ...
                      <ul class="rd-menu rd-navbar-dropdown">
                        <li class="rd-dropdown-item"><a class="rd-dropdown-link" href="pahadi_dals.php"> Pahadi Dals</a>
                        </li>
                       
                         <li class="rd-dropdown-item"><a class="rd-dropdown-link" href="pahadi_dals.php"> Pahadi Basic</a>
                        </li>
                         <li class="rd-dropdown-item"><a class="rd-dropdown-link" href="pahadi_dals.php"> Pahadi Seeds</a>
                        </li>
                         <li class="rd-dropdown-item"><a class="rd-dropdown-link" href="pahadi_dals.php"> Pahadi Masale</a>
                        </li>
                         <li class="rd-dropdown-item"><a class="rd-dropdown-link" href="pahadi_dals.php"> Pahadi Pickles</a>
                        </li>
                         <li class="rd-dropdown-item"><a class="rd-dropdown-link" href="pahadi_dals.php"> Pahadi Flavoured Salts</a>
                        </li>
                        <li class="rd-dropdown-item"><a class="rd-dropdown-link" href="pahadi_dals.php"> Pahadi Squash Juices</a>
                        </li>
                      </ul>
                    </li>
  ...
  <section class="section swiper-container swiper-slider swiper-slider-4" data-loop="true" data-autoplay="5000">
    <div class="swiper-wrapper context-dark">
      <div class="swiper-slide swiper-slide-1" data-slide-bg="sliders/Slide1.jpg">
      ...
      <div class="swiper-slide swiper-slide-2" data-slide-bg="sliders/Slide2.jpg">
      ...
      <div class="swiper-slide swiper-slide-3" data-slide-bg="sliders/Slide3.jpg">
       <!--  <div class="swiper-slide-caption section-md text-center">
          <div class="container">
            <h2 class="swiper-title-1" data-caption-animate="fadeInLeft" data-caption-delay="100">Make Your Food Organic</h2>
            <h5 class="swiper-title-2" data-caption-animate="fadeInRight" data-caption-delay="250">With our wide variety of vegan & organic food products, we are sure <br class="d-none d-md-block">to help you make the right choice to start your day.
        ...
        <div class="swiper-slide swiper-slide-3" data-slide-bg="sliders/Slide4.jpg">
       <!--  <div class="swiper-slide-caption section-md text-center">
          <div class="container">
            <h2 class="swiper-title-1" data-caption-animate="fadeInLeft" data-caption-delay="100">Make Your Food Organic</h2>
            <h5 class="swiper-title-2" data-caption-animate="fadeInRight" data-caption-delay="250">With our wide variety of vegan & organic food products, we are sure <br class="d-none d-md-block">to help you make the right choice to start your day.
  ...
  <section class="section section-xxl bg-image-1">
    <div class="container">
      <div class="row row-xl row-30 row-md-40 row-lg-50 align-items-center">
        ...
        <div class="col-md-2 col-xl-4 d-none d-md-block wow fadeScale"><img src="banners/png_1.png" alt="" width="399" height="407"/>
        </div>
        <div class="col-md-5 col-xl-4">
          <div class="row row-30 row-md-40 row-lg-50 bordered-2">
            <div class="col-sm-6 col-md-12">
  ...
  <!-- Counter Modern-->
  <section class="parallax-container" data-parallax-img="banners/cover_1.jpg">
            ...
            <div class="product-wrap-1 bg-image-1 block-1">
              ...
              <div class="owl-carousel owl-style-5" data-items="1" data-margin="30" data-dots="true" data-autoplay="true">
                <article class="product-creative">
                  <div class="product-figure"><img src="banners/mini_slider.jpg" alt="" width="470" height="324"/>
                  </div>
                  <h4 class="product-creative-title"><a href="single-product.html">Lassan Pickle</a></h4>
                 
                </article>
                <article class="product-creative">
                  <div class="product-figure"><img src="banners/mini_slider1.jpg" alt="" width="470" height="324"/>
                  </div>
                  <h4 class="product-creative-title"><a href="single-product.html">Mix Pickle</a></h4>
          ...
          <div class="card-group-custom card-group-corporate" id="accordion1" role="tablist" aria-multiselectable="false">
            ...
            <article class="card card-custom card-corporate wow fadeInRight" data-wow-delay=".1s">
              <div class="card-header" role="tab">
                <div class="card-title"><a id="accordion1-card-head-gryeiswm" data-toggle="collapse" data-parent="#accordion1" href="#accordion1-card-body-iegmsoqu" aria-controls="accordion1-card-body-iegmsoqu" aria-expanded="true" role="button">Be Healthier and Happier
                    <div class="card-arrow">
                      <div class="icon"></div>
                    </div></a></div>
              </div>
              <div class="collapse show" id="accordion1-card-body-iegmsoqu" aria-labelledby="accordion1-card-head-gryeiswm" data-parent="#accordion1" role="tabpanel">
                <div class="card-body">
            ...
            <article class="card card-custom card-corporate wow fadeInRight" data-wow-delay=".2s">
              <div class="card-header" role="tab">
                <div class="card-title"><a class="collapsed" id="accordion1-card-head-ifdcjqai" data-toggle="collapse" data-parent="#accordion1" href="#accordion1-card-body-kqlogksg" aria-controls="accordion1-card-body-kqlogksg" aria-expanded="false" role="button">It’s the Best Way to Help Animals
                    <div class="card-arrow">
                      <div class="icon"></div>
                    </div></a></div>
              </div>
              <div class="collapse" id="accordion1-card-body-kqlogksg" aria-labelledby="accordion1-card-head-ifdcjqai" data-parent="#accordion1" role="tabpanel">
                <div class="card-body">
            ...
            <article class="card card-custom card-corporate wow fadeInRight" data-wow-delay=".3s">
              <div class="card-header" role="tab">
                <div class="card-title"><a class="collapsed" id="accordion1-card-head-widcbdfi" data-toggle="collapse" data-parent="#accordion1" href="#accordion1-card-body-dqlxgrxe" aria-controls="accordion1-card-body-dqlxgrxe" aria-expanded="false" role="button">Slim Down and Become Energized
                    <div class="card-arrow">
                      <div class="icon"></div>
                    </div></a></div>
              </div>
              <div class="collapse" id="accordion1-card-body-dqlxgrxe" aria-labelledby="accordion1-card-head-widcbdfi" data-parent="#accordion1" role="tabpanel">
                <div class="card-body">
  ...
  <section class="parallax-container" data-parallax-img="banners/cover_2.jpg">
      ...
      <div class="container">
        <div class="row row-30 justify-content-center align-items-center align-items-md-end">
          ...
          <div class="col-lg-9 inset-lg-bottom-10">
            <!-- RD Mailform-->
            <form class="rd-form rd-mailform rd-form-inline form-lg rd-form-text-center" data-form-output="form-output-global" data-form-type="subscribe" method="post" action="https://livedemo00.template-help.com/html/vegano/bat/rd-mailform.php">
